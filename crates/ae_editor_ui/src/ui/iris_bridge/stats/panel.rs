...
//! Stats and telemetry panel layout building and in-place value updates.
//!

use super::cpu_breakdown::{
    CpuBreakdownNodes, build_cpu_breakdown_content, update_cpu_breakdown_values,
};
use super::gpu_breakdown::{
    GpuBreakdownNodes, build_gpu_breakdown_content, update_gpu_breakdown_values,
};
use super::graph::{FramePacingNodes, build_frame_pacing_content, update_frame_pacing_values};
use super::metrics::{
