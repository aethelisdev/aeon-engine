...
// ── Row 4: System, Shaders & Directional Controls (Layers 16..19) ──────────────

/// Cogwheel/gear icon representing engine content, system settings, and configuration - Layer 16.
pub const ICON_GEAR: [f32; 4] = [0.0, 0.0, 1.0, 16.0];
