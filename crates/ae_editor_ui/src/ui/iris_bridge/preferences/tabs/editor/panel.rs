...
//! physics simulation rate, live runtime reload, and snap mode dropdown popup.

use super::history::build_history_card;
use super::physics::build_physics_card;
use super::runtime::build_runtime_card;
use super::snapping::{build_snapping_card, render_snap_mode_dropdown_popup};
use super::types::EditorCardContext;
use crate::ui::iris_bridge::preferences::types::{
    PreferencesDropdownId, PreferencesParams, PreferencesTargets,
};
use irisui::prelude::*;
