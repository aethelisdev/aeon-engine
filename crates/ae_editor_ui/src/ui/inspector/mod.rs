                                ...
                                ui.group(|ui| {
                                    ...
                                    egui::Grid::new("transform_grid")
                                        ...
                                        .show(ui, |ui| {
                                            ...
                                            let (changed, drag_started, drag_stopped, is_dragging, reset_clicked) = draw_vec3_row(
                                                ui, "Position", &mut pos_arr, 0.1, 3, 0.0
                                            );
                                            ...
                                            // --- ROTATION (Euler Degrees - Memory Persistent) ---
                                            if let Ok(r) = world.get::<&ae_core::ecs::Rotation>(entity) {
                                                ...
                                                // Sync from ECS if entity changed OR rotation differs heavily (updated by Gizmo)
                                                let dot = current_q.v.x * ui_q.v.x + current_q.v.y * ui_q.v.y + current_q.v.z * ui_q.v.z + current_q.s * ui_q.s;
                                                if *last_selected_entity != *selected_entity || dot.abs() < 0.9999 {
                                            ...
                                            if *last_selected_entity != *selected_entity {
                                                *last_selected_entity = *selected_entity;
                                                ...
                                                // NEW: persistent color hex state
                                            ...
                                            let (changed, drag_started, drag_stopped, is_dragging, reset_clicked) = draw_vec3_row(
                                                ui, "Rotation", inspector_euler, 1.0, 1, 0.0
                                            );
                                            ...
                                            let (changed, drag_started, drag_stopped, is_dragging, reset_clicked) = draw_vec3_row(
                                                ui, "Scale", &mut scale_arr, 0.01, 3, 1.0
                                            );
