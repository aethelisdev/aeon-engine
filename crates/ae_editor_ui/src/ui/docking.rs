            ...
            PanelId::Stats => {
                EngineUi::draw_stats_content(
                    ...
                    crate::ui::panels::stats::StatsPanelContext {
                        ...
                        fps: self.fps,
                        profiler_ecs_ms: self.profiler_ecs_ms,
                        profiler_physics_ms: self.profiler_physics_ms,
                        profiler_render_ms: self.profiler_render_ms,
                        profiler_present_ms: self.profiler_present_ms,
                        profiler_ui_ms: self.profiler_ui_ms,
                        profiler_frame_ms: self.profiler_frame_ms,
                        memory_models_mb: self.memory_models_mb,
                        memory_textures_mb: self.memory_textures_mb,
                        render_draw_calls: self.render_draw_calls,
