...
/// Handles spawning standard UI primitive entities into the ECS world.
pub fn handle_spawn_ui_element(ctx: &mut UiContext, ui_type: crate::ui::UiElementType) {
    let ent = match ui_type {
        crate::ui::UiElementType::Panel => ctx.world.spawn((
            ae_core::ecs::Name("UI Panel".to_string()),
        ...
        crate::ui::UiElementType::ProgressBar => ctx.world.spawn((
            ae_core::ecs::Name("UI Progress Bar".to_string()),
            ae_core::ecs::UiElement {
                anchor: ae_core::ecs::UiAnchor::TopLeft,
                offset: [120.0, 36.0],
                size: [180.0, 16.0],
                pivot: [0.5, 0.5],
                z_index: 10,
            ...
            ae_core::ecs::UiProgressBar::default(),
        )),
        crate::ui::UiElementType::HealthBar => ctx.world.spawn((
            ae_core::ecs::Name("Player Health Bar".to_string()),
            ae_core::ecs::UiElement {
                anchor: ae_core::ecs::UiAnchor::TopLeft,
                offset: [120.0, 36.0],
                size: [180.0, 16.0],
        ...
        crate::ui::UiElementType::Text => ctx.world.spawn((
            ae_core::ecs::Name("UI Text".to_string()),
            ae_core::ecs::UiElement {
                anchor: ae_core::ecs::UiAnchor::Center,
                offset: [0.0, 0.0],
                size: [200.0, 30.0],
        ...
        crate::ui::UiElementType::ScoreDisplay => ctx.world.spawn((
            ae_core::ecs::Name("Score Display".to_string()),
            ae_core::ecs::UiElement {
                anchor: ae_core::ecs::UiAnchor::TopRight,
                offset: [-100.0, 36.0],
                size: [160.0, 24.0],
                pivot: [0.5, 0.5],
                z_index: 10,
            ...
            ae_core::ecs::UiText::new("SCORE: 00000", 16.0).with_color([1.0, 0.85, 0.2, 1.0]),
            ae_core::ecs::ScoreDisplayTag,
        )),
        crate::ui::UiElementType::Button => ctx.world.spawn((
            ae_core::ecs::Name("UI Button".to_string()),
            ae_core::ecs::UiElement {
                anchor: ae_core::ecs::UiAnchor::Center,
                offset: [0.0, 0.0],
                size: [140.0, 36.0],
        ...
        crate::ui::UiElementType::Image => ctx.world.spawn((
            ae_core::ecs::Name("UI Image".to_string()),
            ae_core::ecs::UiElement {
                anchor: ae_core::ecs::UiAnchor::Center,
                offset: [0.0, 0.0],
                size: [64.0, 64.0],
            ...
            ae_core::ecs::UiImage::default(),
        )),
        crate::ui::UiElementType::Slider => ctx.world.spawn((
            ae_core::ecs::Name("UI Slider".to_string()),
            ae_core::ecs::UiElement {
                anchor: ae_core::ecs::UiAnchor::Center,
                offset: [0.0, 0.0],
                size: [160.0, 24.0],
            ...
            ae_core::ecs::UiSlider::default(),
        )),
        crate::ui::UiElementType::Checkbox => ctx.world.spawn((
            ae_core::ecs::Name("UI Checkbox".to_string()),
            ae_core::ecs::UiElement {
                anchor: ae_core::ecs::UiAnchor::Center,
                offset: [0.0, 0.0],
                size: [120.0, 24.0],
            ...
            ae_core::ecs::UiCheckbox::default(),
        )),
        crate::ui::UiElementType::TextInput => ctx.world.spawn((
            ae_core::ecs::Name("UI Text Input".to_string()),
            ae_core::ecs::UiElement {
                anchor: ae_core::ecs::UiAnchor::Center,
                offset: [0.0, 0.0],
                size: [180.0, 32.0],
            ...
            ae_core::ecs::UiTextInput::default(),
        )),
    };

    ctx.editor.selected_entities.clear();
    ctx.editor.selected_entities_set.clear();
    ctx.editor.selected_entities.push(ent);
