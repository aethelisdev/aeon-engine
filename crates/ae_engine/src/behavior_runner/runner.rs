...
//! Behavior execution loop orchestrating physics impacts, triggers, combat, and native behaviors.
//!
...
use super::{
    collision_bridge, combat, destructible, moving_platform, native_behavior, rotator, trigger_zone,
};
