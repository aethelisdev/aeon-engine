...
pub mod prelude {
    ...
    pub use iris_widgets::{
        ...
        ComboboxPopupStyle, ConsoleEmptyNoticeBuilder, ConsoleFilterLevel, ConsoleLogCounts,
        ...
        ModalDialogBuilder, ModalDialogFrame, ModalDialogStyle, NumericInputEditState,
        NumericInputPillBuilder, NumericInputStyle, PanelBuilder, PropertyRowBuilder,
        ResponsiveGrid, SectionHeaderBuilder, SliderBuilder, StatusBarBuilder, TabBuilder,
