...
pub mod prelude {
    ...
    pub use iris_widgets::{
        ...
        CONSOLE_TAG_SEARCH_INPUT, CanvasBuilder, CardBuilder, CardFrame, CardIcon, CardStyle,
        CascadingMenuBuilder, CascadingMenuFrame, CascadingMenuIcon, CascadingMenuItem,
        CascadingMenuStyle, ChartDrawer, ChartStyle, ChartThreshold, CheckboxBuilder,
        ColorPickerBuilder, ColorPickerClickAction, ColorPickerCursor, ColorPickerDragMode,
        ComboboxPopupBuilder, ComboboxPopupFrame, ComboboxPopupStyle, ConsoleFilterLevel,
        ConsoleToolbarAction, ConsoleToolbarCursor, ContextMenuBuilder, ContextMenuHeader,
